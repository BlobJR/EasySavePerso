...
namespace EasySave.Desktop.ViewModels
{
    public class HomePageViewModel : INotifyPropertyChanged
    {
        ...
        private ObservableCollection<Job> _selectedJobs = new ObservableCollection<Job>();
        ...
        {
            saveManager.PauseJob(SelectedJobs.ToList());
        }

        private void ResumeJob()
        {
            saveManager.ResumeJob(SelectedJobs.ToList());
        }
